...
export default function Brands() {
  ...
  const brandsMetadata: CustomMetadata = {
    title: "24h Tyres - Quality Tyre Brands | 24h Tyres",
    ...
    url: "/tyres/brands",
    imageUrl: "https://24h-tyres.co.uk/all-tyre-brands.jpg",
    canonical: "https://24h-tyres.co.uk/tyres/brands",
    keywords: "24h Tyres, Tyre brands, quality tyres, car tyres, truck tyres, motorcycle tyres, 24/7 tyre services",
  }
  ...
  return (
      <>
          <SeoMetadata metadata={brandsMetadata}/>
          <Script
            id="app-ld-json"
          ...
          <main className="flex flex-col items-center justify-between justify-center">
              ...
              <div className="flex flex-col w-full lg:w-4/5 p-2">
                <div className={`my-4 flex flex-col gap-4`}>
                  <h1 className={`text-6xl font-bold`}>Tyre Brands</h1>
                  <p className={`font-light`}>Choosing the correct tyres is vital for ensuring your safety and that of other motorists. Our store offers a diverse range of tyre options, featuring everything from globally renowned brands to unique models from niche, local manufacturers. Our unparalleled selection and product availability simply cannot be found elsewhere.</p>
                ...
                <div className={`my-4 flex flex-col gap-4`}>
                  <p className={`font-light`}>
                    Tyre producers across the globe frequently include mid-range tyres in their product portfolios. Brands that are well-known in this segment include BFGoodrich, Falken, Firestone, Fulda, Hankook, GT, and Yokohama. These tyres provide exceptional cost-effectiveness. They strike a balance between the quality of premium tyres and the affordability of economy tyres. Ideal for city and highway driving, these tyres are suitable for a variety of vehicles, ranging from compact city cars to somewhat larger automobiles.
                  </p>
                  ...
                  <div className={`grid grid-cols-3 gap-12 my-4 items-center justify-center`}>
                    ...
                    <div>
                      <Link href={`/tyres/brands/hankook`}>
                        <Image src="/tyre-brands/hankook.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand HANKOOK"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/falken`}>
                        <Image src="/tyre-brands/falken.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand FALKEN"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/fulda`}>
                        <Image src="/tyre-brands/fulda.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand FULDA"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/gt`}>
                        <Image src="/tyre-brands/gt.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre GT"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/bfgoodrich`}>
                        <Image src="/tyre-brands/BFGoodrich.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand BF GOODRICH"/>
                      </Link>
                    </div>
                  </div>
                </div>
                ...
                <div className={`my-4 flex flex-col gap-4`}>
                  <p className={`font-light`}>
                    If budget-friendly tyres are what you&apos;re after, the economy class is an excellent choice. Brands like Roadstone, Mazzini, Nexen, Sumitomo, Kormoran and Sailun, along with several others that may not be as widely recognized but are equally deserving of consideration, fall into this category. Such tyres are frequently recommended by manufacturers to drivers with a more relaxed driving style, primarily city dwellers, or those owning smaller or less powerful vehicles. These economical tyres typically employ previously utilized technologies that were once prominent in premium models.
                  </p>

                  <div className={`grid grid-cols-3 gap-12 my-4 items-center justify-center`}>
                    <div>
                      <Link href={`/tyres/brands/roadstone`}>
                        <Image src="/tyre-brands/roadstone.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand ROADSTONE"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/firestone`}>
                        <Image src="/tyre-brands/firestone.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand MAZZINI"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/nexen`}>
                        <Image src="/tyre-brands/nexen.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand NEXEN"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/sumitomo`}>
                        <Image src="/tyre-brands/sumitomo.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand SUMITOMO"/>
                      </Link>
                    </div>
                    <div>
                      <Link href={`/tyres/brands/kormoran`}>
                        <Image src="/tyre-brands/kormoran.svg"
                               width={240}
                               height={240}
                               alt="Picture of Tyre Brand KORMORAN"/>
                      </Link>
                    </div>
                    <div>
                ...
                <div className={`my-4 grid grid-cols-2 gap-4`}>
                  <p className={`font-light`}>
                    We offer a wide range of tire options catering to various vehicle types, not limited to car tire models. Whether you need van tires, 4x4 tires, or motorcycle tires (including those for quads and scooters), we have you covered. Our inventory also includes sought-after Run Flat and reinforced tires. To assist you in making the right choice, we provide a helpful Tire Comparison Tool.
                  </p>
                  <p className={`font-light`}>
                    Should you find yourself uncertain, don&apos;t hesitate to reach out to us. Our team of knowledgeable consultants undergo regular training and possess a deep understanding of the offerings from different tire manufacturers. They are passionate automotive enthusiasts, equipped to address any inquiries and guide you in selecting the most suitable tires that align with your preferences and requirements.
                  </p>
                </div>
